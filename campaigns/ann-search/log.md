...
Reported: 73,908 queries per second against an exact reference at 19,302, a
speedup of 3.83, at recall 1.0.
...
serious vector search library already ship, and 3.83x over a scalar reference
is an ordinary payoff for vectorising an inner loop.

An earlier run of this pack (store research-ann, superseded) reported roughly
172x at recall 0.9025. That figure is withdrawn and must not be quoted. It was
